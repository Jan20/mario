import { flatten, mat4, mult, translate } from "../tux-tutorial-common/MV";
import { quad } from "../tux-tutorial-common/webgl-utils";
...
export class Background {
    ...
    public draw(): void {
        ...
        GLS.I().GL.bindTexture(GLS.I().GL.TEXTURE_2D, this.world.levelTextures.background.textures[0]);
