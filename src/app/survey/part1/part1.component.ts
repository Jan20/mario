...
export class Part1Component implements OnInit {
  ...
  public async continue(): Promise<void> {
     ...
     this.active != '' ? await this.surveyService.survey.storeFunRanking(this.rankOne, this.rankTwo) : null
    ...
    this.active != '' ? this.router.navigate(['survey/part_2']) : this.displayHint = true
  }
